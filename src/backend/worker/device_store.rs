//! Compatibility for returning to the previous Whatsapp build after the library's migration.
//!
//! The protocol library owns the device schema and all message-secret access.
//! Its new migration drops an unused column that the earlier library still writes. Retain that
