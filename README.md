...
- **Desktop notifications.** Get notifications when you are away from the open
  chat. Muted chats do not notify you. On macOS, notifications use the installed
  Whatsapp app's name and icon. If macOS cannot find the app, delivery is skipped
  without opening an application chooser.
